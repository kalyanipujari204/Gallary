...
const App: React.FC = () => {
  ...
  // FIX: Initialize useRef with null. While useRef() is valid, explicitly setting it to null is clearer and common practice for refs that will hold DOM elements or class instances. This might fix an underlying issue causing the error on this line.
